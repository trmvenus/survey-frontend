...
export const getCurrentUser = () => {
  let user = null;
  try {
    user = localStorage.getItem('survey_current_user') != null ? JSON.parse(localStorage.getItem('survey_current_user')) : null;
  } catch (error) {
...
export const setCurrentUser = (user) => {
  try {
    if (user) {
      localStorage.setItem('survey_current_user', JSON.stringify(user))
    } else {
