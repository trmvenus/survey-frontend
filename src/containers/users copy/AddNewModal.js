    ...
    if (isEdit) {
      updateUserAction(
        user.id,
        {
          ...
          email: values.email,
          role: values.role,
          organization_id: values.category
        }
      )
    }
    else {
    ...
    >
      <Formik
        initialValues={{
          ...
          password: user.email?'123456':'',
          category: user.organization_id ? user.organization_id : '',
          ...
          <Form>
            ...
            <ModalFooter>
              ...
              <Button color="primary" type="submit">
                <IntlMessages id={isEdit ? "menu.save" : "pages.submit"} />
              </Button>{' '}
            </ModalFooter>
          </Form>
        )}
